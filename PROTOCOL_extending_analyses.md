...
| C | `Z6219` and `L166` in the Aesch/Muttenz cohort | A cohort with its own power question, so a new document rather than an extension: `PREREG_testC_aesch_muttenz.md` | **REGISTERED 2026-07-26, not staged.** Power written before any read exists |
